...
|---|---|---|---|---|
| 003 | [Read and write conditional format rules on a Sheet](plans/003-sheets-conditional-formatting/plan.md) | active | — | [#26](https://github.com/gitronald/gdrives/pull/26) |
| 000 | [Add mv command for Drive rename and move](plans/000-mv-command/plan.md) | draft | — | — |
